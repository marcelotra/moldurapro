...
export const isSupabaseConfigured =
  SUPABASE_URL !== https://pzjxgemaaevdwiyrhvcc.supabase.co &&
  SUPABASE_ANON_KEY !== eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB6anhnZW1hYWV2ZHdpeXJodmNjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE2Nzc4MDksImV4cCI6MjA3NzI1MzgwOX0.a0EGvih3zx_CdoeBk2DJntP86k9qVJi-u73kjZzbiSc;
...
if (isSupabaseConfigured && supabase) {
  ...
  console.warn("Credenciais do Supabase não encontradas em 'services/supabaseClient.ts'. Rodando em modo de demonstração.");
}